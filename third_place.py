...
DATA = '../input/hubmap-kidney/hubmap-kidney-segmentation/test/'
MODELS_rsxt50 = [f'../input/hubmap-kidne/hubmaptest44/fold{i}.pth' for i in range(5)]
MODELS_rsxt101 = [f'../input/hubmap-kidne/hubmaptest45/fold{i}.pth' for i in range(5)]


df_sample = pd.read_csv('../input/hubmap-kidne/hubmap-kidney-segmentation/sample_submission.csv')
bs = 4
